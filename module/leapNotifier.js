...
register("renderWorld", () => {
    ...
    //ChatLib.clearChat(8008135);
    //if (waitingFor.length > 0) new Message(`&6[&8byebyegoldor&6]&r &7Waiting for ${waitingFor.length} ${waitingFor.length == 1 ? "person" : "people"}`).setChatLineId(8008135).chat();
